...
#
# The version is declared in exactly ONE place — src/Reactor/Reactor.csproj — and read from there, so the package, the binary and
...
SOURCE_FILE="${HERE}/../src/Reactor/Reactor.csproj"
